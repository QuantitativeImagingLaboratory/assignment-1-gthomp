...
class binary_image:
    ...
    def find_optimal_threshold(self, hist):
        ...
        (uprev,vprev) = (0,0)
        u = self.expected_value(hist[:threshold],0,num_pixels)
        v = self.expected_value(hist[threshold:],threshold,num_pixels)  # had t instead of threshold may need to change
        threshold = int((u+v)/2)
    ...
    def binarize(self, image):
        ...
        bin_img = image.copy()
        row,col = bin_img.shape # added this
